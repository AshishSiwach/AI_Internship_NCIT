# -*- coding: utf-8 -*-
"""Mistral-7b-New_Prompt.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1wTE4oLwneCzcdLplOzSKxwZSZvEuEw9A
...
class ModelConfig:
    ...
    HUB_MODEL_ID = "TripleH/Mistral-7B-Instruct-v0.3-qlora-modular-new_prompt"

    # --- Data and Paths ---
    # The input file path
    INPUT_FILE_PATH = "/content/drive/MyDrive/Colab/football_dataset_contrarian_claims_with_reasoning.csv"
    OUTPUT_DIR = "/content/drive/MyDrive/football_model_mistral_new_prompt/results"
    LOGGING_DIR = "/content/drive/MyDrive/football_model_mistral_new_prompt/logs"
...
"""### Format Prompt and Data Transformation for Mistral-7B"""
...
class BatchInferenceConfig:
    ...
    ADAPTER_MODEL_PATH = "TripleH/Mistral-7B-Instruct-v0.3-qlora-modular-new_prompt"
    ...
    OUTPUT_DATA_PATH = "/content/drive/MyDrive/Colab/predictions_Mistral-7B-Instruct-v0.3.csv"
    # The name for a cleaner CSV with just the claims and predictions.
    CLEAN_OUTPUT_DATA_PATH = "/content/drive/MyDrive/Colab/predictions_clean_Mistral-7B-Instruct-v0.3.csv"
...
class EvaluationConfig:
    ...
    OUTPUT_DATA_PATH = "/content/drive/MyDrive/Colab/evaluation_results_Mistral-7B-Instruct-v0.3.csv"
    # The name of the file where the average evaluation metrics will be saved.
    MEAN_RESULTS_FILE_PATH = "/content/drive/MyDrive/Colab/mean_evaluation_results_Mistral-7B-Instruct-v0.3.csv"
